...
public class LTC_Work {
	...
	public LTC_Work(URL url, String auth) throws IOException {
		this(url, url, auth);
	}
	
	public LTC_Work(URL url, URL mainUrl, String auth) throws IOException {
		this((HttpURLConnection) url.openConnection(), url, auth);
	}

	public LTC_Work(HttpURLConnection conn, URL mainUrl, String auth) throws IOException {
	...
	public boolean meetsTarget(int nonce, LTC_Hasher hasher) throws GeneralSecurityException {
	...
	public static boolean test() {
		try {
			...
			byte[] hash = new LTC_Hasher().hash(header);
